    ...
    for (var i = 0; i < cards.length; i++) {
        ...
        for (const type of types) {
            if (type.types.indexOf(card.type) != -1) {
                ...
                div.innerHTML = '<div class="data"><div class="id">' + (i + index) + '.5</div><div class="type">' + type.name + '</div></div></div><div class="button block-button" style="margin-bottom: 0.5em; width: 90%">Check</div>';
